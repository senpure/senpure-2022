...
public class ContainerPermissionService extends BaseService {
    ...
    @Autowired
    public void setContainerPermissionMapper(ContainerPermissionMapper containerPermissionMapper) {
        this.containerPermissionMapper = containerPermissionMapper;
    }
    ...
    public ContainerPermissionPageResult findPage(ContainerPermissionCriteria criteria) {
        ContainerPermissionPageResult pageResult = ContainerPermissionPageResult.success();
        //是否是主键查找
        if (criteria.getId() != null) {
            ...
            if (containerPermission != null) {
                ...
                pageResult.setContainerPermissions(containerPermissions);
            } else {
