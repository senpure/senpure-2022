...
public class AccountCriteriaStr extends CriteriaStr implements Serializable {
    ...
    private String name;
    @ApiModelProperty(dataType = "date-time", example = "2020-05-20 00:00:00", position = 34)
    ...
    @ApiModelProperty(dataType = "long", example = "1589904000000", position = 40)
    private String banExpiryTime;
    @ApiModelProperty(dataType = "date-time", example = "2020-05-20 00:00:00", position = 41)
    ...
    //本次登录时间
    @ApiModelProperty(value = "本次登录时间", dataType = "long", example = "1589904000000", position = 43)
    private String loginTime;
    //本次登录时间
    @ApiModelProperty(value = "本次登录时间", dataType = "date-time", example = "2020-05-20 00:00:00", position = 44)
    ...
    @ApiModelProperty(dataType = "long", example = "1589904000000", position = 52)
    private String lastLoginTime;
    @ApiModelProperty(dataType = "date-time", example = "2020-05-20 00:00:00", position = 53)
    ...
    @ApiModelProperty(dataType = "long", example = "1589904000000", position = 55)
    private String lastLogoutTime;
    @ApiModelProperty(dataType = "date-time", example = "2020-05-20 00:00:00", position = 56)
    ...
    @ApiModelProperty(value = "createDate 开始范围 (>=)", dataType = "date-time", example = "2020-05-20 00:00:00", position = 64)
    private String startCreateDate;
    @ApiModelProperty(value = "createDate 结束范围 (<=)", dataType = "date-time", example = "2020-05-20 23:59:59", position = 65)
    private String endCreateDate;
    @DynamicDate
    private PatternDate startCreateDateValid = new PatternDate();
    @DynamicDate
    private PatternDate endCreateDateValid = new PatternDate();
    @ApiModelProperty(value = "banExpiryTime 开始范围 (>=)", dataType = "long", example = "1589904000000", position = 66)
    private String startBanExpiryTime;
    @ApiModelProperty(value = "banExpiryTime 结束范围 (<=)", dataType = "long", example = "1589904000000", position = 67)
    private String endBanExpiryTime;
    @ApiModelProperty(value = "banExpiryDate 开始范围 (>=)", dataType = "date-time", example = "2020-05-20 00:00:00", position = 68)
    private String startBanExpiryDate;
    @ApiModelProperty(value = "banExpiryDate 结束范围 (<=)", dataType = "date-time", example = "2020-05-20 23:59:59", position = 69)
    private String endBanExpiryDate;
    @DynamicDate
    private PatternDate startBanExpiryDateValid = new PatternDate();
    @DynamicDate
    private PatternDate endBanExpiryDateValid = new PatternDate();
    @ApiModelProperty(value = "loginTime 开始范围 (>=)", dataType = "long", example = "1589904000000", position = 70)
    private String startLoginTime;
    @ApiModelProperty(value = "loginTime 结束范围 (<=)", dataType = "long", example = "1589904000000", position = 71)
    private String endLoginTime;
    @ApiModelProperty(value = "loginDate 开始范围 (>=)", dataType = "date-time", example = "2020-05-20 00:00:00", position = 72)
    private String startLoginDate;
    @ApiModelProperty(value = "loginDate 结束范围 (<=)", dataType = "date-time", example = "2020-05-20 23:59:59", position = 73)
    ...
    @ApiModelProperty(value = "lastLoginTime 开始范围 (>=)", dataType = "long", example = "1589904000000", position = 74)
    private String startLastLoginTime;
    @ApiModelProperty(value = "lastLoginTime 结束范围 (<=)", dataType = "long", example = "1589904000000", position = 75)
    private String endLastLoginTime;
    @ApiModelProperty(value = "lastLoginDate 开始范围 (>=)", dataType = "date-time", example = "2020-05-20 00:00:00", position = 76)
    private String startLastLoginDate;
    @ApiModelProperty(value = "lastLoginDate 结束范围 (<=)", dataType = "date-time", example = "2020-05-20 23:59:59", position = 77)
    private String endLastLoginDate;
    @DynamicDate
    private PatternDate startLastLoginDateValid = new PatternDate();
    @DynamicDate
    private PatternDate endLastLoginDateValid = new PatternDate();
    @ApiModelProperty(value = "lastLogoutTime 开始范围 (>=)", dataType = "long", example = "1589904000000", position = 78)
    private String startLastLogoutTime;
    @ApiModelProperty(value = "lastLogoutTime 结束范围 (<=)", dataType = "long", example = "1589904000000", position = 79)
    private String endLastLogoutTime;
    @ApiModelProperty(value = "lastLogoutDate 开始范围 (>=)", dataType = "date-time", example = "2020-05-20 00:00:00", position = 80)
    private String startLastLogoutDate;
    @ApiModelProperty(value = "lastLogoutDate 结束范围 (<=)", dataType = "date-time", example = "2020-05-20 23:59:59", position = 81)
    private String endLastLogoutDate;
    @DynamicDate
    private PatternDate startLastLogoutDateValid = new PatternDate();
    @DynamicDate
    private PatternDate endLastLogoutDateValid = new PatternDate();
    //table [senpure_account][column = create_date] criteriaOrder
    @ApiModelProperty(value = "createDate 排序" , allowableValues = "ASC,DESC", position = 82)
    private String createDateOrder;
    //table [senpure_account][column = ban_expiry_date] criteriaOrder
    @ApiModelProperty(value = "banExpiryDate 排序" , allowableValues = "ASC,DESC", position = 83)
    private String banExpiryDateOrder;
    //table [senpure_account][column = login_date] criteriaOrder
    @ApiModelProperty(value = "loginDate 排序" , allowableValues = "ASC,DESC", position = 84)
    private String loginDateOrder;
    //table [senpure_account][column = last_login_date] criteriaOrder
    @ApiModelProperty(value = "lastLoginDate 排序" , allowableValues = "ASC,DESC", position = 85)
    private String lastLoginDateOrder;
    //table [senpure_account][column = last_logout_date] criteriaOrder
    @ApiModelProperty(value = "lastLogoutDate 排序" , allowableValues = "ASC,DESC", position = 86)
    private String lastLogoutDateOrder;
    //table [senpure_account][column = container_id] criteriaOrder
    @ApiModelProperty(value = "containerId 排序" , allowableValues = "ASC,DESC", position = 87)
