...
public class URIPermission implements Serializable {
    ...
    @ApiModelProperty(example = "uriAndMethod", position = 1)
    private String uriAndMethod;
    //是否从数据库更新过
    @ApiModelProperty(value = "是否从数据库更新过", dataType = "boolean", position = 2)
    private Boolean databaseUpdate;
    //(外键,modelName:Permission,tableName:senpure_permission)
    @ApiModelProperty(value = "(外键,modelName:Permission,tableName:senpure_permission)", dataType = "long", example = "666666", position = 3)
