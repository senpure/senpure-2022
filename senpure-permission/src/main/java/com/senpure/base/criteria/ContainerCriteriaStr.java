...
public class ContainerCriteriaStr extends CriteriaStr implements Serializable {
    ...
    @ApiModelProperty(dataType = "date-time", example = "2020-05-20 00:00:00", position = 14)
    ...
    @ApiModelProperty(value = "createDate 开始范围 (>=)", dataType = "date-time", example = "2020-05-20 00:00:00", position = 18)
    private String startCreateDate;
    @ApiModelProperty(value = "createDate 结束范围 (<=)", dataType = "date-time", example = "2020-05-20 23:59:59", position = 19)
    ...
    @ApiModelProperty(value = "createDate 排序" , allowableValues = "ASC,DESC", position = 20)
    private String createDateOrder;
    //table [senpure_container][column = parent_id] criteriaOrder
    @ApiModelProperty(value = "parentId 排序" , allowableValues = "ASC,DESC", position = 21)
