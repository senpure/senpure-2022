...
public class RoleCriteriaStr extends CriteriaStr implements Serializable {
    ...
    private String name;
    @ApiModelProperty(dataType = "date-time", example = "2020-05-22 00:00:00", position = 8)
    ...
    @ApiModelProperty(value = "createDate 开始范围 (>=)", dataType = "date-time", example = "2020-05-22 00:00:00", position = 12)
    private String startCreateDate;
    @ApiModelProperty(value = "createDate 结束范围 (<=)", dataType = "date-time", example = "2020-05-22 23:59:59", position = 13)
    ...
    //table [senpure_role][column = name] criteriaOrder
    @ApiModelProperty(value = "name 排序" , allowableValues = "ASC,DESC", position = 14)
    private String nameOrder;
    //table [senpure_role][column = create_date] criteriaOrder
    @ApiModelProperty(value = "createDate 排序" , allowableValues = "ASC,DESC", position = 15)
    private String createDateOrder;
    //table [senpure_role][column = container_id] criteriaOrder
    @ApiModelProperty(value = "containerId 排序" , allowableValues = "ASC,DESC", position = 16)
    ...
    /**
     * get table [senpure_role][column = name] criteriaOrder
     *
     * @return
     */
    ...
    /**
     * set table [senpure_role][column = name] criteriaOrder DESC||ASC
     *
     * @return
     */
