...
public class TypeRegistry {
    ...
    static {
        ...
        ignorablePackagePrefixes['o' - 'a'] = new String[]{"org/springsource/loaded/", "org/objectweb/asm",
                ...
                "org/hibernate/", "org/hsqldb/", "org/aspectj/", "org/xml/", "org/h2/","org/springframework/boot/loader"};
    }
               ...
               // log.info("----url " + url.toString());
                ...
                if (!reloadable && protocol.equals("jar")) {
                    if (GlobalConfiguration.jarsToWatch != null) {
                        ...
                        int bangSlash = urlstring.lastIndexOf("jar!/");
                        if (bangSlash != -1) {
                            String pathInJar = urlstring.substring(bangSlash + 5);
                            String remainingPrefix = urlstring.substring(0, bangSlash + 3);
                            int lastSlash = remainingPrefix.lastIndexOf("/");
                            String jarname = remainingPrefix.substring(lastSlash + 1);
                           // log.info("----jarname " + jarname);
                           // log.info("----jarsToWatch " + Arrays.toString(GlobalConfiguration.jarsToWatch));
