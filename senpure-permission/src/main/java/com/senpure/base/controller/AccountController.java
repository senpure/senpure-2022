...
import com.senpure.base.service.AccountValueService;
...
import com.senpure.base.verify.ResourceVerifyAccountService;
import com.senpure.base.verify.ResourceVerifyContainerService;
import com.senpure.base.verify.ResourceVerifyRoleService;
...
public class AccountController extends BaseController {
    ...
    public ModelAndView readAccounts(HttpServletRequest request, @ModelAttribute("criteria") AccountCriteria criteria) {
        ...
        AccountPageResult accountPageResult = accountService.findPage(criteria);

        ResultMap resultMap = ResultMap.result(accountPageResult.getCode());
        resultMap.putTotal(accountPageResult.getTotal());
        resultMap.put(AccountPageResult.RECORDS_NAME, accountPageResult.getAccounts());
    ...
    public ModelAndView readAccounts(HttpServletRequest request, @Valid @ModelAttribute("criteria") AccountCriteria criteria, BindingResult validResult) {
        ...
        AccountPageResult  pageResult = accountService.findPage(criteria);
        ResultMap resultMap = ResultMap.result(pageResult .getCode());
        resultMap.putTotal(pageResult .getTotal());
        resultMap.put(AccountPageResult.RECORDS_NAME, pageResult .getAccounts());
        return view(request, view, resultMap);
    }
