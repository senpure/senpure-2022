...
import com.senpure.base.verify.ResourceVerifyPermissionService;
...
public class RoleController extends BaseController {
    ...
    public ModelAndView readRoles(HttpServletRequest request,
        ...
        RolePageResult pageResult = authorizeService.loadRoles(criteria);
        ResultMap resultMap = ResultMap.result(pageResult.getCode());
        resultMap.putItems(RolePageResult.RECORDS_NAME, pageResult.getRoles());
        resultMap.putTotal(pageResult.getTotal());
        return view(request, "authorize/role", resultMap);
    }
