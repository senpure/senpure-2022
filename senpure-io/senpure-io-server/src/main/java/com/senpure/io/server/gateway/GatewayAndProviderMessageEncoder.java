 ...
 */
public class GatewayAndProviderMessageEncoder extends MessageToByteEncoder<GatewayReceiveConsumerMessage> {
    protected final Logger logger = LoggerFactory.getLogger(getClass());


    @Override
    protected void encode(ChannelHandlerContext ctx, GatewayReceiveConsumerMessage msg, ByteBuf out) throws Exception {
