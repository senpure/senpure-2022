...
public class JpaConfig {
    ...
    private String configurePartName = "configure";
    private String resultPartName = "result";

    private String configureSuffix = "Configuration";
    ...
    private String startRangePrefix = "start";
    private String endRangePrefix = "end";
    /**
    ...
    public String getConfigurePartName() {
        return configurePartName;
    }

    public void setConfigurePartName(String configurePartName) {
        this.configurePartName = configurePartName;
    }
    ...
    public String getConfigureSuffix() {
        return configureSuffix;
    }

    public void setConfigureSuffix(String configureSuffix) {
        this.configureSuffix = configureSuffix;
    }
    ...
    public String getStartRangePrefix() {
        return startRangePrefix;
    }

    public void setStartRangePrefix(String startRangePrefix) {
        this.startRangePrefix = startRangePrefix;
    }

    public String getEndRangePrefix() {
        return endRangePrefix;
    }

    public void setEndRangePrefix(String endRangePrefix) {
        this.endRangePrefix = endRangePrefix;
    }
}
