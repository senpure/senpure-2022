...
/**
 * @author senpure
 * @time 2021-5-31 22:15:30
 */
public class CSMatchingSuccessMessage extends CompressMessage {
    ...
    public void copy(CSMatchingSuccessMessage source) {
    ...
    public CSMatchingSuccessMessage setServerName(String serverName) {
    ...
    public CSMatchingSuccessMessage setServerKey(String serverKey) {
    ...
    public CSMatchingSuccessMessage setDataId(int dataId) {
        this.dataId = dataId;
        return this;
    }
    ...
    public CSMatchingSuccessMessage setData(byte [] data) {
        this.data = data;
        return this;
    }
    ...
    public String toString() {
        return "CSMatchingSuccessMessage[123]{"
    ...
    public String toString(String indent) {
        ...
        sb.append("CSMatchingSuccessMessage").append("[123]").append("{");
        sb.append("\n");
