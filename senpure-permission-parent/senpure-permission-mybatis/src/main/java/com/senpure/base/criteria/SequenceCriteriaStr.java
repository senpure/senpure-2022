...
public class SequenceCriteriaStr extends CriteriaStr implements Serializable {
    ...
    private String span;
    //table [senpure_sequence][column = type] criteriaOrder
    @ApiModelProperty(value = "type 排序" , allowableValues = "ASC,DESC", position = 14)
    ...
    /**
     * get table [senpure_sequence][column = type] criteriaOrder
     *
     * @return
     */
    ...
    /**
     * set table [senpure_sequence][column = type] criteriaOrder DESC||ASC
     *
     * @return
     */
